...
var h1Pad = document. querySelector ("h1")

for (var i = 0; i < siteTitles.length; i++) {
    siteTitles[i].setAttribute("style", "color:blue; font-size: 30px;  font-weight: bold");
   }

   h1Pad.setAttribute("style", "margin: 0px; padding-left: 10px"); 
